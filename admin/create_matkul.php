...
<body>
  ...
  <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8"/>
    ...
    <div class="container mt-3">
        ...
        <form method="POST">
        <div class="mb-3 mt-3">
                <label for="email">Mata Kuliah</label>
            ...
            <div class="mb-3 mt-3">
                <label for="email">Nilai Ujian</label>
...
if (isset($_POST['create_new'])) {
    $matkul = mysqli_real_escape_string($konek, $_POST['matkul']);
    $dosen = mysqli_real_escape_string($konek, $_POST['dosen']);
    $nilai = mysqli_real_escape_string($konek, $_POST['nilai']);
 

    $query = "INSERT INTO matkul VALUES ('', '$matkul', '$dosen', '$nilai')";
    ...
    if ($query_run) {
        ...
        header("Location: create_matkul.php");
        exit;
    }
}
else {
