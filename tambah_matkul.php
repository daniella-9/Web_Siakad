                    ...
                    <div id="main">
                        <div class="container mt-3">
                                <table class="table table-bordered table-primary">
                                    ...
                                    <form method="POST" action="submit_matkul.php">
                                        <div class="form-check">
                                            <tbody>
                                            <?php
                                                $username = $_SESSION['username'];
                                                $namabah_matkul = "SELECT * FROM matkul";
                                                $query_run = mysqli_query($konek, $namabah_matkul);

                                                if (mysqli_num_rows($query_run) > 0) {
                                                    foreach ($query_run as $data) { ?>
                                                <tr class="table-primary">
                                                    <td width="10px">
                                                        <input class="form-check-input" type="checkbox" name="matkul[]"
                                                            value="<?= $data['matkul'] ?>">
                                                    </td>
                                                    <td width="800px">
                                                    ...
                                                    <td width="250px">
                                                        <label class="form-check-label" for="sks">
                                                            <?= $data['sks'] ?>
                                                        </label>
                                                    </td>
                                                </tr>
                            ...
                            <div class="col-auto">
                    <button type="submit" name="tambah_matkul" class="btn btn-primary">Submit</button>
                </div>
                </form>
